CREATE DATABASE two_trees_dbf4;

-- swith to the db before querying
-- Create the Two Trees Database 
-- For PostgreSQL:
    -- Comment out lines 23, 25, and 27
    -- Modify lines 63 and 76
...
CREATE TABLE sales.order_lines (
    order_id    INT,
    line_id     INT IDENTITY(1,1) NOT NULL PRIMARY KEY, --PostgreSQL: use GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1)
    sku         VARCHAR(7),
    quantity    INT
);
